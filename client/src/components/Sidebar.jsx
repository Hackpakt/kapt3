...
const Sidebar = () => {
  ...
  const menuItems = [
    { title: "KAPT3", icon: <FaHome />, href: "/" }, // Main page redirect
    { title: "Exchange", icon: <FaExchangeAlt />, href: "#" }, // Redirects to an external URL
    { title: "Stats", icon: <FaShoppingCart />, href: "#" }, // Redirects to an external URL
